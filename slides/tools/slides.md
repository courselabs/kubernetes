...
<div v-click="1">
<carbon-list class="inline-block text-2xl text-blue-400" /> <code>kubectl get all</code>
</div>
<div v-click="2">
<carbon-view class="inline-block text-2xl text-green-400" /> <code>kubectl get pods --watch</code>
</div>
<div v-click="3">
<carbon-tag class="inline-block text-2xl text-purple-400" /> <code>kubectl get pods -l app=web</code>
</div>
<div v-click="4">
<carbon-edit class="inline-block text-2xl text-yellow-400" /> <code>kubectl edit deployment web</code>
</div>
<div v-click="5">
<carbon-delete class="inline-block text-2xl text-red-400" /> <code>kubectl delete pod --all</code>
</div>
<div v-click="6">
<carbon-search class="inline-block text-2xl text-blue-400" /> <code>kubectl get events</code>
</div>
<div v-click="7">
<carbon-application class="inline-block text-2xl text-green-400" /> <code>kubectl apply -f file.yaml</code>
</div>
<div v-click="8">
<carbon-debug class="inline-block text-2xl text-purple-400" /> <code>kubectl logs -f pod-name</code>
</div>
</div>

<div v-click="9" class="mt-8 text-center text-lg">
<carbon-keyboard class="inline-block text-2xl text-green-400" /> Practice until it's muscle memory
</div>
...
<span class="text-sm opacity-80">Use shortcuts everywhere</span>
</div>
<div v-click="2">
<carbon-keyboard class="text-4xl text-blue-400 mb-2" />
<strong>Setup aliases</strong><br/>
<span class="text-sm opacity-80">First thing in exam</span>
</div>
<div v-click="3">
<carbon-document class="text-4xl text-purple-400 mb-2" />
<strong>Use explain</strong><br/>
<span class="text-sm opacity-80">When syntax unclear</span>
</div>
<div v-click="4">
<carbon-terminal class="text-4xl text-yellow-400 mb-2" />
<strong>Imperative first</strong><br/>
<span class="text-sm opacity-80">Generate YAML quickly</span>
</div>
<div v-click="5">
<carbon-automatic class="text-4xl text-green-400 mb-2" />
<strong>Tab completion</strong><br/>
<span class="text-sm opacity-80">Save typing time</span>
</div>
<div v-click="6">
<carbon-debug class="text-4xl text-red-400 mb-2" />
<strong>Systematic debug</strong><br/>
<span class="text-sm opacity-80">get → describe → logs</span>
</div>
</div>
