...
You can use the reverse proxy setup from here as a starting point, but the specs don't include a namespace: [reverse-proxy/nginx.yaml](labs/namespaces/specs/reverse-proxy/nginx.yaml). <!--- Broken linke -->
